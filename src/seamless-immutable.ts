...
function immutableInit(config: IConfig = { use_static: false }) {
  ...
  function Immutable<T extends IAnyObject>(obj: T, options?: IPrototype, stackRemaining: number = 64) {
    if (isImmutable(obj) || isReactElement(obj) || isFileObject(obj) || isBlobObject(obj) || isError(obj)) {
      ...
      for (var key in obj) {
        if (Object.getOwnPropertyDescriptor(obj, key)) {
          clone[key] = Immutable(obj[key], undefined, stackRemaining - 1);
        }
      }
